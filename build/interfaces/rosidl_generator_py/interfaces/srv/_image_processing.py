...
class Metaclass_ImageProcessing(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.srv.ImageProcessing')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from interfaces.srv import _image_processing
...
class ImageProcessing(metaclass=Metaclass_ImageProcessing):
    from interfaces.srv._image_processing import ImageProcessing_Request as Request
    from interfaces.srv._image_processing import ImageProcessing_Response as Response
