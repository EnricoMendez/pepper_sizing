...
static const _ImageProcessing_Request_type_support_symbol_names_t _ImageProcessing_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ImageProcessing_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, ImageProcessing_Request)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::ImageProcessing_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, ImageProcessing_Request)() {
  return get_message_type_support_handle<interfaces::srv::ImageProcessing_Request>();
}
...
static const _ImageProcessing_Response_type_support_symbol_names_t _ImageProcessing_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ImageProcessing_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, ImageProcessing_Response)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::ImageProcessing_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, ImageProcessing_Response)() {
  return get_message_type_support_handle<interfaces::srv::ImageProcessing_Response>();
}
...
static const _ImageProcessing_type_support_symbol_names_t _ImageProcessing_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ImageProcessing)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, ImageProcessing)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::ImageProcessing_service_type_support_handle;
}
